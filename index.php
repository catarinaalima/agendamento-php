...
<html lang="pt-br">
  ...
  <body>
      ...
      <div class="jumbotron"> 
    	   <h1 class="text-center">Agendamento - Tech Desktop</h1>
           <h3 class="text-center">Agende seu horário de acordo com sua disponibilidade.</h3> 
           <hr class="my-4">
           <!-- <h4 class="text-center">Para mais informações sobre o serviço, entro em contato.</h4>-->
    </div><br>
        ...
        <div class="col-sm-6 col-sm-offset-3">	
                ...
                <option>MANUTENÇÃO CORRETIVA -- A CONSULTAR</option>
                <option>MANUTENÇÃO PREVENTIVA -- R$80,00</option> 
                <option>FORMATAÇÃO COMPLETA -- R$60,00</option> 
                <option>FORMATAÇÃO SIMPLES -- R$40,00</option> 
                <option>TROCA E INSTALAÇÃO DE PEÇAS -- R$20,00</option> 
                <option>MONTAGEM COMPLETA -- R$ 50,00</option> 
  			...
  			<div class="col-sm-6 col-sm-offset-3">
    			...
    			<div class="col-sm-offset-3 col-sm-6"><br>
      				<button type="submit" class="btn btn-info">Agendar</button><br>
